...
if __name__ == "__main__":
    sample_text = """While versus during, do these two words confuse you? Come on," \
    let's understand. While is a conjunction and it's used with a subject plus verb.
    It is used to show that two actions happen at the same time. Example, I was
    cooking while she was watching TV. She smiled while talking to me. Now, during,
    it's a preposition and we use it with a noun, not with a full sentence. It's used
    to show something happened in a period of time, specific period of time. I met many people
    during the conference. Now, a conference happens in a specific period of time. I fell asleep
    during the movie. Now, these two sentences, where will you use while and during?
