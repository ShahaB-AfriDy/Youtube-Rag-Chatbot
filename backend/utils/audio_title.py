...
def extract_audio_title(youtube_url: str, output_folder: str = "downloaded_audio") -> tuple[str | None, str | None]:
    """
...
if __name__ == "__main__":
    path, title = extract_audio_title("https://www.youtube.com/shorts/3s0dAdpZGx0")
